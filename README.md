...
# Hi, I'm Xin Xue Yuan · 新v学员

**AI agent tooling author** — MCP servers, agent skills, and runtime plugins that help models do real work.

```text
Agent  ·  MCP  ·  Image tools  ·  Bot ecosystems  ·  Windows / Linux
```
...
Tools that plug AI agents into real systems — image generation, GitHub API, and safe execution.
...
<p align="center">
  <i>Open to collaboration on agent tooling, MCP, and bots — let's build 🌱</i>
</p>
