...
> 专注 Python / Rust / TypeScript · 机器人生态 · AI 图像生成工具链
...
| [winux](https://github.com/xinvxueyuan/winux) | 面向 Windows 的 Rust 风格 Linux CLI 工作流管理器 | Rust |
| [orbital-marketplace](https://github.com/xinvxueyuan/orbital-marketplace) | 应用商城 SPA：下载 / 许可证 / 更新 / 订阅 | JavaScript |

## 🎯 当前在做

- 🤖 **[lingchu-bot](https://github.com/xinvxueyuan/lingchu-bot)** — QQ 群管理机器人生态
- 🎨 **AI 图像工具链** — NovelAI MCP 与生成工作流
- 🪟 **[winux](https://github.com/xinvxueyuan/winux)** — Windows 上的类 Linux CLI
